...
-- Date        : Wed Oct  6 21:29:06 2021
-- Host        : ece36 running 64-bit Ubuntu 20.04.2 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top ip_design_nco_0_0 -prefix
--               ip_design_nco_0_0_ ip_design_nco_0_0_sim_netlist.vhdl
...
entity ip_design_nco_0_0_nco_AXILiteS_s_axi is
  port (
    ...
    reset : out STD_LOGIC;
    int_sine_sample_V_ap_vld : out STD_LOGIC;
    s_axi_AXILiteS_ARREADY : out STD_LOGIC;
    O : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \int_step_size_V_reg[7]_0\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \int_step_size_V_reg[11]_0\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \int_step_size_V_reg[14]_0\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
...
architecture STRUCTURE of ip_design_nco_0_0_nco_AXILiteS_s_axi is
  ...
  signal \int_step_size_V[15]_i_1_n_0\ : STD_LOGIC;
  ...
  signal wnext : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  attribute SOFT_HLUTNM of FSM_sequential_rstate_i_1 : label is "soft_lutpair7";
  attribute FSM_ENCODED_STATES of FSM_sequential_rstate_reg : label is "rddata:1,rdidle:0";
  attribute SOFT_HLUTNM of \int_step_size_V[0]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \int_step_size_V[10]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \int_step_size_V[11]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \int_step_size_V[12]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \int_step_size_V[13]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \int_step_size_V[14]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \int_step_size_V[15]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \int_step_size_V[1]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \int_step_size_V[2]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \int_step_size_V[3]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \int_step_size_V[4]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \int_step_size_V[5]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \int_step_size_V[6]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \int_step_size_V[7]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \int_step_size_V[8]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \int_step_size_V[9]_i_1\ : label is "soft_lutpair11";
  attribute ADDER_THRESHOLD : integer;
  attribute ADDER_THRESHOLD of q0_reg_0_i_1 : label is 35;
  attribute ADDER_THRESHOLD of q0_reg_0_i_12 : label is 35;
  ...
  attribute SOFT_HLUTNM of \rdata_data[11]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \rdata_data[14]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \rdata_data[15]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \rdata_data[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \rdata_data[3]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \rdata_data[4]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rdata_data[5]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rdata_data[6]_i_1\ : label is "soft_lutpair4";
...
\int_step_size_V[15]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\int_step_size_V[15]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\temp_V_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => \int_step_size_V_reg[14]_0\(3 downto 0),
...
\temp_V_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => \int_step_size_V_reg[7]_0\(3 downto 0),
...
\temp_V_reg[8]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => \int_step_size_V_reg[11]_0\(3 downto 0),
...
architecture STRUCTURE of ip_design_nco_0_0_nco_sine_lut_V_rom is
  signal int_sine_sample_V : STD_LOGIC_VECTOR ( 0 to 0 );
...
q0_reg_0: unisim.vcomponents.RAMB36E1
    generic map(
      ...
      DOADO(7 downto 1) => \out\(6 downto 0),
      DOADO(0) => int_sine_sample_V(0),
...
q0_reg_1: unisim.vcomponents.RAMB36E1
    generic map(
      ...
      DOADO(7 downto 0) => \out\(14 downto 7),
...
nco_sine_lut_V_rom_U: entity work.ip_design_nco_0_0_nco_sine_lut_V_rom
     port map (
      ...
      s_axi_AXILiteS_ARADDR(1 downto 0) => s_axi_AXILiteS_ARADDR(1 downto 0),
...
architecture STRUCTURE of ip_design_nco_0_0_nco is
  ...
  signal int_sine_sample_V : STD_LOGIC_VECTOR ( 15 downto 1 );
  signal int_sine_sample_V_ap_vld : STD_LOGIC;
  ...
  signal nco_AXILiteS_s_axi_U_n_19 : STD_LOGIC;
...
nco_AXILiteS_s_axi_U: entity work.ip_design_nco_0_0_nco_AXILiteS_s_axi
     port map (
      ...
      O(3) => nco_AXILiteS_s_axi_U_n_4,
      O(2) => nco_AXILiteS_s_axi_U_n_5,
      O(1) => nco_AXILiteS_s_axi_U_n_6,
      O(0) => nco_AXILiteS_s_axi_U_n_7,
      Q(0) => sine_sample_V_ap_vld,
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      int_sine_sample_V_ap_vld => int_sine_sample_V_ap_vld,
      \int_step_size_V_reg[11]_0\(3) => nco_AXILiteS_s_axi_U_n_12,
      \int_step_size_V_reg[11]_0\(2) => nco_AXILiteS_s_axi_U_n_13,
      \int_step_size_V_reg[11]_0\(1) => nco_AXILiteS_s_axi_U_n_14,
      \int_step_size_V_reg[11]_0\(0) => nco_AXILiteS_s_axi_U_n_15,
      \int_step_size_V_reg[14]_0\(3) => nco_AXILiteS_s_axi_U_n_16,
      \int_step_size_V_reg[14]_0\(2) => nco_AXILiteS_s_axi_U_n_17,
      \int_step_size_V_reg[14]_0\(1) => nco_AXILiteS_s_axi_U_n_18,
      \int_step_size_V_reg[14]_0\(0) => nco_AXILiteS_s_axi_U_n_19,
      \int_step_size_V_reg[7]_0\(3) => nco_AXILiteS_s_axi_U_n_8,
      \int_step_size_V_reg[7]_0\(2) => nco_AXILiteS_s_axi_U_n_9,
      \int_step_size_V_reg[7]_0\(1) => nco_AXILiteS_s_axi_U_n_10,
      \int_step_size_V_reg[7]_0\(0) => nco_AXILiteS_s_axi_U_n_11,
      \out\(14 downto 0) => int_sine_sample_V(15 downto 1),
      \rdata_data_reg[0]_0\ => sine_lut_V_U_n_0,
      reset => reset,
...
entity ip_design_nco_0_0 is
  ...
  attribute x_core_info of ip_design_nco_0_0 : entity is "nco,Vivado 2021.1";
...
architecture STRUCTURE of ip_design_nco_0_0 is
  ...
  signal NLW_U0_s_axi_AXILiteS_RDATA_UNCONNECTED : STD_LOGIC_VECTOR ( 31 downto 16 );
...
U0: entity work.ip_design_nco_0_0_nco
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      s_axi_AXILiteS_ARADDR(5) => '0',
      s_axi_AXILiteS_ARADDR(4 downto 0) => s_axi_AXILiteS_ARADDR(4 downto 0),
      s_axi_AXILiteS_ARREADY => s_axi_AXILiteS_ARREADY,
      s_axi_AXILiteS_ARVALID => s_axi_AXILiteS_ARVALID,
      s_axi_AXILiteS_AWADDR(5) => '0',
      s_axi_AXILiteS_AWADDR(4 downto 0) => s_axi_AXILiteS_AWADDR(4 downto 0),
      ...
      s_axi_AXILiteS_BVALID => s_axi_AXILiteS_BVALID,
      s_axi_AXILiteS_RDATA(31 downto 16) => NLW_U0_s_axi_AXILiteS_RDATA_UNCONNECTED(31 downto 16),
      s_axi_AXILiteS_RDATA(15 downto 0) => \^s_axi_axilites_rdata\(15 downto 0),
      s_axi_AXILiteS_RREADY => s_axi_AXILiteS_RREADY,
