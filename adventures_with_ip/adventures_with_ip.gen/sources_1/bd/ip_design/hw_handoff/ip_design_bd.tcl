...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.FREQ_HZ {12345679} \
 ] $FCLK_CLK1_0
  set LEDs_out [ create_bd_port -dir O -from 3 -to 0 LEDs_out ]
  set PBDATA_0 [ create_bd_port -dir O PBDATA_0 ]
  set PBLRCLK_0 [ create_bd_port -dir O PBLRCLK_0 ]
  set RECDAT_0 [ create_bd_port -dir I RECDAT_0 ]
  set RECLRCLK_0 [ create_bd_port -dir O RECLRCLK_0 ]
  ...
  # Create instance: lms_pcore_0, and set properties
  set lms_pcore_0 [ create_bd_cell -type ip -vlnv ac.uk:user:lms_pcore:1.0 lms_pcore_0 ]

  # Create instance: nco_0, and set properties
  set nco_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:nco:1.0 nco_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {12.345679} \
   ...
   CONFIG.PCW_FCLK1_PERIPHERAL_DIVISOR0 {27} \
...
Reset#SD 0#UART 1#UART 1#GPIO#GPIO#GPIO#GPIO}\
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO2 [get_bd_intf_ports sws_4bits] [get_bd_intf_pins axi_gpio_1/GPIO2]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins lms_pcore_0/AXI4_Lite] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins nco_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins ps7_0_axi_periph/M03_AXI] [get_bd_intf_pins zybo_audio_ctrl_0/S_AXI]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins led_controller_0/s00_axi_aresetn] [get_bd_pins lms_pcore_0/AXI4_Lite_ARESETN] [get_bd_pins lms_pcore_0/IPCORE_RESETN] [get_bd_pins nco_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins zybo_audio_ctrl_0/S_AXI_ARESETN]
  connect_bd_net -net zybo_audio_ctrl_0_BCLK [get_bd_ports BCLK_0] [get_bd_pins zybo_audio_ctrl_0/BCLK]
  connect_bd_net -net zybo_audio_ctrl_0_PBDATA [get_bd_ports PBDATA_0] [get_bd_pins zybo_audio_ctrl_0/PBDATA]
  connect_bd_net -net zybo_audio_ctrl_0_PBLRCLK [get_bd_ports PBLRCLK_0] [get_bd_pins zybo_audio_ctrl_0/PBLRCLK]
  connect_bd_net -net zybo_audio_ctrl_0_RECLRCLK [get_bd_ports RECLRCLK_0] [get_bd_pins zybo_audio_ctrl_0/RECLRCLK]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs led_controller_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs lms_pcore_0/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0x43C20000 -range 0x00008000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs nco_0/s_axi_AXILiteS/Reg] -force
  assign_bd_address -offset 0x60000000 -range 0x00004000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs zybo_audio_ctrl_0/S_AXI/reg0] -force
